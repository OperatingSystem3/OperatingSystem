...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200444:	a8050513          	addi	a0,a0,-1408 # 80200ec0 <etext+0x520>
    ...
    80200454:	a6050513          	addi	a0,a0,-1440 # 80200eb0 <etext+0x510>
    ...
    80200468:	0141                	addi	sp,sp,16
                sbi_shutdown();
    8020046a:	a1fd                	j	80200958 <sbi_shutdown>
...
void trap(struct trapframe *tf) { trap_dispatch(tf); }
    8020047a:	8082                	ret
            print_trapframe(tf);
    8020047c:	b5cd                	j	8020035e <print_trapframe>
        interrupt_handler(tf);
    8020047e:	b781                	j	802003be <interrupt_handler>
